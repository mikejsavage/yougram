...
func photogrid(photos []Photo, asset_base_url string, thumbnail_base_url string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "\" @load=\"fullscreen_asset_loaded = true\" @error=\"fullscreen_asset_failed = true\" :style=\"Visible( !fullscreen_asset_failed )\"></div><div class=\"settings\"><span style=\"font-weight: bold\" x-text=\"fullscreen\"></span> <span x-text=\"photos[ fullscreen ].asset\"></span> <span x-text=\"fullscreen_thumbnail_loaded\"></span> <span x-text=\"fullscreen_asset_loaded\"></span> [cog] [bin]</div></div></template><img x-init=\"MakeThumbhash( $el, photos[ visible_range[ 0 ] + i - 1 ].thumbhash )\"> <img :src=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 232, Col: 103}
		}
...
func shareButton(album sqlc.GetAlbumByURLRow, ownership AlbumOwnership) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 300, Col: 5}
		}
		...
		if ownership == AlbumOwnership_Owned {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 323, Col: 58}
			}
...
func downloadButton(album sqlc.GetAlbumByURLRow, ownership AlbumOwnership) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 360, Col: 29}
		}
...
func albumTemplate(album sqlc.GetAlbumByURLRow, photos []Photo, ownership AlbumOwnership, can_upload bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 620, Col: 20}
		}
		...
		if ownership != AlbumOwnership_Owned {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 623, Col: 33}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 627, Col: 26}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 627, Col: 75}
		}
...
func guestAlbumTemplate(album sqlc.GetAlbumByURLRow, photos []Photo, can_upload bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 692, Col: 47}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `photo_grid.templ`, Line: 693, Col: 167}
		}
