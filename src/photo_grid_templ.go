...
func fullscreen(base_urls BaseURLs) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\" @load=\"asset_loaded = true\" @error=\"asset_failed = true\" x-show=\"!asset_failed\"></div></template><template x-if=\"GetPhoto().video\"><div class=\"stack\"><img x-init=\"MakeThumbhash( $el, GetPhoto().thumbhash )\" x-show=\"!asset_loaded\"><video controls :src=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
