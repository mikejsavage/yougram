...
func navlink(current_url string, link templ.SafeURL, text string, match_prefix bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if isCurrentPage(current_url, link, match_prefix) {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `base.templ`, Line: 33, Col: 29}
			}
			...
			templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinURLErrs(link)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `base.templ`, Line: 35, Col: 16}
			}
...
func createAlbumButton() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<div x-data=\"{\n\t\tname: '',\n\t\turl: '',\n\t\tauto_slug: true,\n\t\tshared: false,\n\t}\"><button command=\"show-modal\" commandfor=\"createalbum\" @click=\"ResetForms\">Create album</button> <dialog x-data=\"{ error: '' }\" style=\"max-width: 20rem\" id=\"createalbum\" @click=\"DialogClicked\" @yougram:album_created=\"$el.close()\"><form hx-put=\"/Special:createAlbum\" x-htmx.json=\"albums\" x-htmx-error=\"error\"><h2>New album</h2><label>Name<br><input type=\"text\" name=\"name\" x-model=\"name\" autocomplete=\"off\" autofocus required></label><fieldset><legend><label for=\"url\">URL</label></legend> <input type=\"text\" name=\"url\" x-model=\"url\" autocomplete=\"off\" x-effect=\"if( auto_slug ) { url = MakeSlug( name ); }\" :readonly=\"auto_slug\" required> <button style=\"display: inline-flex; align-items: center; gap: 0.25em\" @click=\"selecting = !selecting\"><input type=\"checkbox\" x-model=\"auto_slug\" :checked=\"auto_slug\"> Auto</button></fieldset><label><input type=\"checkbox\" x-model=\"shared\"> Shared</label> <button type=\"submit\" style=\"width: min-content\">Save</button> <span class=\"error hideempty\" x-text=\"error\"></span></form></dialog></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func base(title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "<!doctype html><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1,viewport-fit=cover\"><title>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `base.templ`, Line: 89, Col: 15}
		}
		...
		if favicon != nil {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "<link rel=\"icon\" type=\"image/png\" href=\"/favicon.png\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
...
func baseWithSidebar(user User, current_url string, title string, body templ.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `base.templ`, Line: 337, Col: 34}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `base.templ`, Line: 383, Col: 21}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var16))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 19, "gram</b><hr>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 20, "<a href=\"/Special:logout\">Log out</a><hr>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
